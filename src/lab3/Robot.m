    ...
    methods
        ...
        function PV = run_trajectory(self, trajCoeff, time, inJointSpace)
            ...
            while time - timeOff > 0
                ...
                if inJointSpace
                    ...
                    %velData = [velData; posVelData(2,:)]; If we want
                    %values as degrees, use the above 2.
        ...
        function a = calculateTrajAcc(self,trajCoeff,time)
            ...
            for i = 3:length(trajCoeff)
                a = a + (i-1)*(i)*trajCoeff(i)*time^(i-3); 
            end
            return
        end
        ...
        %takes a 1x3 set of joint angles and returns the 3x3 of jacobian
        %matrix
        function jacob3001(jointAngles)
